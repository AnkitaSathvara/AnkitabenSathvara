...
$(document).ready(function() {
    $("#openGazetteerModal").click(function(e) {
        e.preventDefault();
        $("#gazetteer-modal").modal("show");
    });

    $("#openCompanyDirectoryModal").click(function(e) {
        e.preventDefault();
        $("#company-directory-modal").modal("show");
    });
});
...
(function ($) {
    ...
    var submit = $('#submit-btn'); // submit button
            ...
            form.on('submit', function(e) {
                ...
                $.ajax({
                    url: 'assets/php/mail.php', // form action url
